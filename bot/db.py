...
_ALTER_STATEMENTS = [
    ...
    "ALTER TABLE users ADD COLUMN IF NOT EXISTS role_locked_until TIMESTAMP",
    ...
    "ALTER TABLE lamps ADD COLUMN IF NOT EXISTS bc_chat VARCHAR(64)",
    "ALTER TABLE lamps ADD COLUMN IF NOT EXISTS bc_mid VARCHAR(32)",
]
