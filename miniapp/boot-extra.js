(() => {
  ["scroll-perf.js", "carousel-sync.js", "keyboard-fix.js", "deep-open.js", "share.js", "boot-rescue.js", "pin-fix.js", "share-fix.js", "home-head.js", "search-ui.js", "detail-polish.js"].forEach((name) => {
    const id = "yycj-" + name.replace(".js", "");
    if (document.getElementById(id)) return;
    const s = document.createElement("script");
    s.id = id;
    s.src = "./" + name + "?v=20260911aw";
...
#pins .pin-card{flex:0 0 34%!important;width:34%!important;min-width:34%!important;aspect-ratio:3/4!important;height:auto!important;}
...
#yycjGallery .gallery-hero video{background:#111;}
